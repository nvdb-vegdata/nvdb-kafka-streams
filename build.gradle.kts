...
val cleanUberiketGenerated by tasks.registering(Delete::class) {
    description = "Delete previously generated Uberiket API Kotlin sources"
    group = "openapi tools"
    delete("$projectDir/src/generated/kotlin/no/vegvesen/nvdb/api/uberiket")
}
...
val generateUberiketApi by tasks.registering(org.openapitools.generator.gradle.plugin.tasks.GenerateTask::class) {
    ...
    outputDir.set("$projectDir/src/generated/kotlin")
